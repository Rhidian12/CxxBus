...
{
  EXPECT_EQ(MarshalDBusType(Variant(static_cast<uint8_t>(0x07))), (std::vector<byte>{0x01, 'y', 0x00,  // signature "y"
                                                                                     0x07}));          // value
  ...
  EXPECT_EQ(MarshalDBusType(Variant("Hi!")), (std::vector<byte>{
                                                              0x01, 's', 0x00,  // signature "s"
                                                              0x00,  // pad to 4-byte boundary
                                                              0x03, 0x00, 0x00, 0x00,  // string length = 3
                                                              'H', 'i', '!', 0x00,  // string + null terminator
  ...
  EXPECT_EQ(MarshalDBusType(Variant(std::string(""))), (std::vector<byte>{
                                                           0x01, 's', 0x00,  // signature "s"
                                                           0x00,  // pad to 4-byte boundary
  ...
  EXPECT_EQ(MarshalDBusType(Variant(std::vector<uint32_t>{1, 2})), (std::vector<byte>{
  ...
  EXPECT_EQ(MarshalDBusType(Variant(std::make_tuple(static_cast<uint8_t>(0x01), static_cast<uint32_t>(0x11223344)))), (std::vector<byte>{
  ...
  EXPECT_EQ(MarshalDBusType(Variant(in_place, Variant(static_cast<uint8_t>(0x07)))), (std::vector<byte>{
