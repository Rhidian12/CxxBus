...
function(define_test_or_benchmark)
  ...
  if(NOT DO_NOT_ADD_TO_CACHE)
    ...
    if(DU_UNIT_TEST)
      ...
      set(all_benchmarks_sources   ${_ALL_BENCHMARKS_SOURCES})
      set(all_benchmarks_libraries ${_ALL_BENCHMARKS_LIBRARIES})
      set(all_benchmarks_includes  ${_ALL_BENCHMARKS_INCLUDES})
    endif()
