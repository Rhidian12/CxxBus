...
{
  EXPECT_EQ(UnmarshalDBusType<int32_t>({0x00, 0x00, 0x00, 0x80}, "i"),
...
{
  EXPECT_EQ(UnmarshalDBusType<int64_t>(
...
{
  EXPECT_EQ(UnmarshalDBusType<uint64_t>(
                {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}, "t"),
...
TEST_F(UnmarshalTestSuite, UnmarshalDouble)
{
  ...
  EXPECT_DOUBLE_EQ(
      UnmarshalDBusType<double>({0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF0, 0x3F}, "d"), 1.0);
}
...
{
  EXPECT_EQ(UnmarshalDBusType<std::vector<uint32_t>>({0x00, 0x00, 0x00, 0x00}, "au"),
            (std::vector<uint32_t>{}));
}
...
TEST_F(UnmarshalTestSuite, UnmarshalArrayOfUint32)
{
  ...
  EXPECT_EQ(UnmarshalDBusType<std::vector<uint32_t>>(bytes, "au"),
...
TEST_F(UnmarshalTestSuite, UnmarshalArrayOfStringsWithInterElementPadding)
{
  ...
  EXPECT_EQ(UnmarshalDBusType<std::vector<std::string>>(bytes, "as"),
